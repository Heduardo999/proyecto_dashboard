...
def metricas_vendedor():
    ...
    if is_mobile:
        ...
        columnas = 4
        altura_por_fila = 155   # 🔥 antes 180 → ahora más preciso
        gap = 12
        extra = 0               # 🔥 elimina colchón en PC

    filas = math.ceil(num_vendedores / columnas)

    altura = (filas * altura_por_fila) + ((filas - 1) * gap) + extra

    components.html(html_total, height=altura, scrolling=False)
