...
def graph_time_dia():
    ...
    st.plotly_chart(fig_time_dia, use_container_width=True)
...
def graph_time_mes():
    ...
    st.plotly_chart(fig_time_mes, use_container_width=True)
...
def graph_time_dia_vendedores():
    ...
    st.plotly_chart(fig_time_dia_vendedores, use_container_width=True)
